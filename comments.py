...
async def commentphoto(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    crud.add_comment_request(db=bot.session,category_id=category_id,fillial_id=fillial_query,user_id=user_query.id,comment=context.user_data['comment_text'],name=context.user_data['comment_name'],image=context.user_data['image_comment'],)
